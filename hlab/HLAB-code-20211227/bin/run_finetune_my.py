...
from model_utils import BertForSequenceClassification
from data_generate import My_Load_Dataset
...
if __name__ == '__main__':
    ...
    train_dataset = My_Load_Dataset(path="../../../dataset/netMHCIIpan3.2/train_mini.csv", tokenizer_name=model_name, max_length=max_seq_length)
    val_dataset = My_Load_Dataset(path="../../../dataset/netMHCIIpan3.2/eval_mini.csv", tokenizer_name=model_name, max_length=max_seq_length)
    #test_dataset = My_Load_Dataset(path="../../../dataset/netMHCIIpan3.2/test_mini.csv", tokenizer_name=model_name, max_length=max_seq_length)
